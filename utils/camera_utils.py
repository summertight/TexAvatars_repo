...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  ...
                  mask_tongue=cam_info.mask_tongue,
                  mask_tongue_path=cam_info.mask_tongue_path,
                  uid=id,
                  cx = cam_info.cx, cy = cam_info.cy, fl_x = cam_info.fl_x, fl_y = cam_info.fl_y,# justin (for ray map or plucker embedding) 
